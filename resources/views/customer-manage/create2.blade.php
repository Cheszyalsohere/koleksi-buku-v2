...
@section('title', 'Tambah Customer 2 - Foto File')
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center mb-3">
                ...
                <h4 class="card-title mb-0">Tambah Customer 2 — Foto sebagai File</h4>
            </div>
            <p class="text-muted mb-3">Foto diambil dari kamera lalu disimpan sebagai <strong>file gambar</strong>, path disimpan di database.</p>
            ...
            <form id="formCustomer" action="{{ route('customer-manage.store2') }}" method="POST">
                @csrf
                <input type="hidden" name="foto_file" id="fotoFile">
...
$(function(){
    ...
    $('#btnSimpan').on('click', function(){
        ...
        if (!$('#fotoFile').val()) { alert('Silakan ambil foto terlebih dahulu!'); return; }
